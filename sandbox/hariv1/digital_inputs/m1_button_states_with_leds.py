...
Much like we did in hariv1 of the motors unit, later we will show you different (better) ways to use buttons.
...
def main():
    ...
    while True: 
        ...
        #   DONE: 5. Formally test your work. When you think you have the
        # problem complete run these tests:
